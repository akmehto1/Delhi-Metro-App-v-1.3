...
import 'package:metro_oct/direction.dart';
...
class _homepageState extends State<homepage> {
  ...
  final TextEditingController _direction_station=TextEditingController();
        ...
        return AlertDialog(
          ...
          actions: [
            Center(
              child: TextButton(
                onPressed: () {
                   String staion_name=_source.text;
                   print(staion_name);
                   List<double>?find=gps_alaram(staion_name);
                   print(find[0]);
                   Navigator.push(
                     context,
                     MaterialPageRoute(
                       builder: (context) =>direction_page(lat:find[0],lon:find[1]),
                     ),
                   );

                   // Navigator.push(context,MaterialPageRoute(builder:(context)=>direction_page()));
                   // Navigator.of(context).pop();
                },
                child: const Text(
                  'OKs',
                        ...
                        child: Container(
                          ...
                          child: GestureDetector(
                              onTap: () async {
                                ...
                                List<List<String>> result = location(src, des,true);
                                if(result.length==0){
                                  print("not able");
                                }
                        ...
                        child: Container(
                          ...
                          child: GestureDetector(
                              onTap: () async {
                                ...
                                List<List<String>> result = location(src, des,false);
                                List<String> RoutePath = result[0];
                                List<String> colorPath = result[1];
                                Future.delayed(const Duration(seconds: 2), () {
                                  Navigator.push(
